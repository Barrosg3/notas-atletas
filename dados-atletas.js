class Atleta {
    ...
    // 1. Calcula a categoria baseada na idade
    calculaCategoria() {
    ...
    // 2. Calcula o IMC: peso / (altura * altura)
    calculaIMC() {
        return this.peso / (this.altura * this.altura);
    }

    // 3. Calcula a média válida (exclui a maior e a menor nota)
    calculaMediaValida() {
        let notasOrdenadas = this.notas.slice().sort((a, b) => a - b);
        let notasComputadas = notasOrdenadas.slice(1, 4); // Pega do índice 1 ao 3
...
console.log(`Altura: ${atleta.altura}`); // Exibindo altura conforme o exemplo
